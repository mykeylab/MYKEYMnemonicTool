...
func (w *HDWallet) SerializeNoSense() []byte {
	...
	//log.Println("Vbytes:", Vbytes)
	//log.Println("depth:", depth)
	//log.Println("Fingerprint:", Fingerprint)
	//log.Println("I:", I)
	//log.Println("Chaincode:", Chaincode)
	//log.Println("Key:", Key)
...
func (w *HDWallet) StringNoSense() string {
	//log.Println("w.SerializeNoSense():", w.SerializeNoSense())
...
func (w *HDWallet) Pub() *HDWallet {
	if bytes.Compare(w.Vbytes, Public) == 0 {
		...
		//log.Println("w.key:", w.Key)
		//log.Println("privToPub(w.Key):", privToPub(w.Key))
		//log.Println("length:", len(w.Key), ";pub length:", len(privToPub(w.Key)))
